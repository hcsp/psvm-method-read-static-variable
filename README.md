...
请在[`Main.java`](https://github.com/hcsp/psvm-method-read-static-variable/blob/master/src/main/java/com/github/hcsp/Main.java)中创建一个指定的静态成员变量。在提交Pull Request之前，你应当在本地确保所有代码已经编译通过，并且通过了测试(`mvn clean verify`)
